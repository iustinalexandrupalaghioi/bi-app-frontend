import { Filters } from "../../../hooks/useSalesTrendWithDiscounts";
    ...
    <form className="max-w-4xl p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md">
      ...
      <div className="flex flex-col mt-4">
        ...
        <input
          type="number"
          id="predictionYears"
          value={filters.predictionPoints}
          onChange={(e) =>
            setFilters({ ...filters, predictionPoints: Number(e.target.value) })
          }
...
export default SalesTrendRemakeForm;
